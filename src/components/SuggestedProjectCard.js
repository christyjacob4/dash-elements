    ...
    return (
        <div className={`${classes.card} ${classes.projectCard}`}>
            ...
            <div className={"row no-gutters align-items-center"}>
                ...
                <div className={`col ${classes.chipGray} col-auto`}>
                    html
                </div>
            </div>
            ...
            <div className={"row no-gutters align-items-center"} >
                <div className={classes.chipBlue}>
                    1.2 ETH
                </div>
                <div className={`${classes.chipOrange} mr-auto`}>
                    0.3 BTC
                </div>
                <h4 className={"my-auto"}> <span>$</span>760</h4>
            </div>
