    ...
    <div>
      <nav className="navbar navbar-expand-md px-0 py-0 pt-3 pt-md-5 justify-content-start align-items-baseline">
            ...
            <a href="#" className="navbar-brand ml-3 ml-md-0">
              <img className={`${styles.brand}`} src="assets/navbar_brand.svg" alt=""/>
            </a>

            <span className={`navbar-text d-none d-md-inline ${styles.brand}`}><span className={`${styles.brandStrong}`}>Dash</span> Elements</span>
      ...
      <nav className="navbar navbar-expand-md sticky-top px-0 pt-3 pt-md-4 pb-4">
        <div id="collapse-target" className="collapse navbar-collapse">
          <ul className="navbar-nav">
            <li className=""><a href="#" className={`${styles['navbar-item']} &:focus`}>Home</a></li>
            <li className=""><a href="#" className={`${styles['navbar-item']}`}>My Projects</a></li>
            <li className=""><a href="#" className={`${styles['navbar-item']}`}>Payments</a></li>
            <li className=""><a href="#" className={`${styles['navbar-item']}`}>Activity</a></li>
            <li className=""><a href="#" className={`${styles['navbar-item']}`}>Settings</a></li>
          </ul>
        </div>
